...
class DataCorrelationTests(unittest.TestCase):
    ...
    def test_period_years_expand_fixed_table_without_truncation(self):
        ...
        document = Document(PLANTILLAS / 'PEI_Estandar_-_Informe.docx')
...
class XmlCleanupTests(unittest.TestCase):
    ...
    def test_ficha_note_is_removed_as_a_row_and_preserved_as_paragraph(self):
        ...
        table = Document(PLANTILLAS / 'Plantilla_de_ficha_técnica.docx').tables[0]._element
...
PLANTILLAS = PROJECT_ROOT / 'plantillas'
WORKTREE = PLANTILLAS
...
class FreshDocxGenerationTests(unittest.TestCase):
    ...
    def test_anexo_b1_typography_is_scoped_to_target_sentence(self):
        ...
        with tempfile.TemporaryDirectory() as template_dir, tempfile.TemporaryDirectory() as output_dir:
            ...
            shutil.copy(PLANTILLAS / 'PEI_Estandar_-_Informe.docx', template_dir)
            shutil.copy(PLANTILLAS / 'Plantilla_de_ficha_técnica.docx', template_dir)
...
class SecurityRegressionTests(unittest.TestCase):
    def test_server_uses_configured_port_and_host(self):
        ...
        self.assertEqual(http_server.call_args.args[0], ('127.0.0.1', 8123))
